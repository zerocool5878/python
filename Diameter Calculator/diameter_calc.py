...
print "Do you wish to calculate the Diameter or Radius from a circumference measurement? Type 'd' or 'r'"
...
if var == 'd':
	...
	if rnd < denominator:
		print frac
		print "The diameter of a %s circumference is" % cir, frac
	else:
		remain = rnd%denominator
		whole_num = int(rnd/denominator)
		print "The diameter of a %s circumference is" % cir, whole_num, Fraction(int(remain), denominator)
elif var == 'r':
	...
	if rnd < denominator:
		print frac
		print "The radius of a %s circumference is" % cir, frac
	else:
		remain = rnd%denominator
		whole_num = int(rnd/denominator)
		print "The radius of a %s circumference is" % cir, whole_num, Fraction(int(remain), denominator)
else:
